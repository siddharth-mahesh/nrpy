"""
Register function for getting the next {x,y,z}_center and r_{min,max} for external input grid.

Perform quadratic extrapolation on previous 3 centers & radii to get prediction for next one.
