...
Example-specific variant of ``SEOBNRv5_aligned_spin_waveform_from_dynamics_higher_mode`` that
stores all 9 delta-implemented modes (excluding (8,8)) for the low- and fine-sampled ODE
trajectory.
...
def register_CFunction_SEOBNRv5_aligned_spin_waveform_from_dynamics() -> (
    ...
    """
    Register CFunction for computing the inspiral modes of SEOBNRv5 given the dynamics.
    ...
    desc = """
Calculates the SEOBNRv5 inspiral waveform modes (2,2), (2,1), (3,3), (3,2), (4,4), (4,3),
(5,5), (6,6), (7,7) for the low- and fine-sampled ODE trajectory.
...
"""
    ...
    fine_stores = ""
    for l, m in MODES:
        low_stores += f"  commondata->waveform_low[IDX_WF(i,STRAIN{l}{m})] = strain_modes_single_timestep[STRAIN{l}{m}-1];\n"
        fine_stores += f"  commondata->waveform_fine[IDX_WF(i,STRAIN{l}{m})] = strain_modes_single_timestep[STRAIN{l}{m}-1];\n"
