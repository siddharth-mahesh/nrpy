...
"""
    ...
    for lm in modes:
        ...
        declare_HM_input_symbols += f"const REAL {wf.modewise_input_symbols[lm][0]} = hNR[HNR{lm[0]}{lm[1]}];\n"
        ...
        #frequency at t_0
        declare_HM_input_symbols += f"const REAL {wf.modewise_input_symbols[lm][1]} = wNR[WNR{lm[0]}{lm[1]}];\n"
